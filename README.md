...
2. Clone the repository into the folder locally by using git clone: 
   1. **git clone https://github.com/CodeExpert8081/react-game-site.git**
3. Navigate into the directory:
   1. **cd game-website**
4. Install the necessary packages inside package.json:
   1. **npm install**
5. **IMPORTANT: Create an free account with RAWG API to receive your API KEY(REQUIRED FOR DATA TO BE FETCHED)**
6. Create a **.env.local** file inside the root of your directory to paste our API KEY
7. Inside the .env.local file, add your API KEY with the line below:
